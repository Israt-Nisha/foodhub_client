...
import { User, Store, Package, DollarSign } from "lucide-react";
import {
...
export default function VendorProfile({ userId }: Props) {
    ...
    return (
        <div className="container px-4 py-8 max-w-2xl mx-auto">
            <h1 className="text-3xl font-black mb-8 text-foreground tracking-tight text-center sm:text-left">
                ...
                Vendor Profile: <span className="text-primary">{user?.name}</span>
            </h1>
                ...
                <div className="bg-card border border-border rounded-3xl shadow-xl p-8 space-y-6 backdrop-blur-sm">
                    ...
                    <div className="w-full pt-8 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                        <div className="space-y-4">
                            <h3 className="text-sm font-black uppercase tracking-widest text-primary/80">Business Growth</h3>
                        ...
                        <div className="space-y-4">
                            <h3 className="text-sm font-black uppercase tracking-widest text-primary/80">Product Performance</h3>
                            <div className="h-[200px] w-full bg-card/40 rounded-3xl border border-border p-4">
                                <ResponsiveContainer width="100%" height="100%">
                                    <BarChart data={[
                                        { name: 'Stock Level', value: 85 },
                                        { name: 'Customer Rating', value: 92 },
                                        { name: 'Delivery Rate', value: 96 },
                                        { name: 'Return Rate', value: 4 },
                                    ]}>
