...
import { User, ChefHat, Star, TrendingUp } from "lucide-react";
import {
...
export default function ProviderProfile({ userId }: Props) {
    ...
    const fetchUser = async () => {
        ...
        try {
            ...
            if (res.data) {
                ...
                reset({
                    name: res.data.name,
                    restaurantName: (res.data as any).restaurantName || "",
    ...
    return (
        <div className="container px-4 py-8 max-w-2xl mx-auto">
            <h1 className="text-3xl font-black mb-8 text-foreground tracking-tight text-center sm:text-left">
                ...
                Provider Profile: <span className="text-primary">{user?.name}</span>
            </h1>
                ...
                <div className="bg-card border border-border rounded-3xl shadow-xl p-8 space-y-6 backdrop-blur-sm">
                    <div className="flex flex-col md:flex-row gap-6">
                        ...
                        <div className="flex-1 text-center md:text-left">
                            ...
                            <p className="text-lg text-primary font-bold">{(user as any)?.restaurantName}</p>
                    ...
                    <div className="w-full pt-8 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                        <div className="space-y-4">
                            <h3 className="text-sm font-black uppercase tracking-widest text-primary/80">Monthly Revenue</h3>
                        ...
                        <div className="space-y-4">
                            <h3 className="text-sm font-black uppercase tracking-widest text-primary/80">Order Performance</h3>
